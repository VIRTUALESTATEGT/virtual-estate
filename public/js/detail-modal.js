...
window.PropDetail = (() => {
  ...
  const ADIC_CATS = [
    { tipo: 'servicios_basicos',  label: 'Servicios Básicos',          icon: 'fa-plug' },
    { tipo: 'espacios_ambientes', label: 'Espacios y Ambientes',        icon: 'fa-door-open' },
    { tipo: 'adicionales',        label: 'Adicionales y Equipamiento',  icon: 'fa-star' },
    { tipo: 'amenidades',         label: 'Amenidades Comunitarias',     icon: 'fa-swimmer' },
  ];
  const DISP_CLASS = {
