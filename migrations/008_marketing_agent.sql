...
-- 2. Instrucciones globales del agente
...
-- 3. Órdenes de contenido pendientes
...
-- Seed: identidad de marca inicial de Virtual Estate GT
...
VALUES (
  ...
  '#B8860B',
  '#FFFFFF',
  'Marca profesional y elegante. Enfocada en servicios de escaneo 3D, fotografía inmobiliaria y documentación técnica en Guatemala. Tono sofisticado, confiable y moderno. Evitar lenguaje informal o excesivamente técnico.'
) ON CONFLICT (business_id) DO NOTHING;

-- Seed: instrucciones globales iniciales
